...
export default (function (View) {
  ...
  return _a = /** @class */function (_super) {
    ...
    Magnifier.prototype.createFocusAttrController = function () {
      ...
      var scaleC = new ScaleController(dataRecords.map(function (group) {
        return group.children.slice(validStart, validEnd + 1);
      }).flat());
      var attrsRange = __assign(__assign({}, geometry._getThemeAttrsRange()), {
        x: [position[0] - radius, position[0] + radius],
        y: [position[1] - radius, position[1] + radius]
      });
      var attrControllerNew = new AttrController(scaleC, attrsRange);
    ...
    Magnifier.prototype.mapping = function () {
      ...
      var pointsData = focusDataArray.map(function (focusData) {
        ...
        return __assign(__assign({}, attrValues), {
          shape: shape,
    ...
    Magnifier.prototype.render = function () {
      ...
      var _a = this.mapping(),
        ...
        center = _a.center;
      return jsx(View, __assign({}, this.props, {
        pointsData: pointsData,
        radius: radius,
        linesData: linesData,
        center: center
