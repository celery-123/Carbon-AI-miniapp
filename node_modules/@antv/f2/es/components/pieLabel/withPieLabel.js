  ...
  return /** @class */function (_super) {
    ...
    function PieLabel(props) {
      ...
      _this.getSpiderLabels = function (props) {
        ...
        // 高度计算，拿第一项数据作为计算依据
        var label1Text = isFunction(label1) ? label1((_c = records[0]) === null || _c === void 0 ? void 0 : _c.origin, records[0]) : label1;
        var label2Text = isFunction(label2) ? label2((_d = records[0]) === null || _d === void 0 ? void 0 : _d.origin, records[0]) : label2;
        var height = measureText(label1Text.text, __assign({
          fontSize: '24px',
          lineHeight: '24px'
        }, label1Text)).height + measureText(label2Text.text, __assign({
          fontSize: '24px',
          lineHeight: '24px'
