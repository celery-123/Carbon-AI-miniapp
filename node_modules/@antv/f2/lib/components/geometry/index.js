...
var OVERRIDE_FIELDS_SET = new Set(['color', 'normalized', 'x', 'y', 'shapeName', 'shape', 'selected']);
var Geometry = /** @class */function (_super) {
  ...
  Geometry.prototype._getYSnapRecords = function (invertPointY, records) {
    ...
    var originRecordList = (0, _util.flatten)(this.dataRecords.map(function (r) {
      return r.children;
    }));
    // linear
    return records.filter(function (record, idx) {
      var _a;
      var isOverrideField = OVERRIDE_FIELDS_SET.has(yField);
      var rangeY = isOverrideField ? (_a = originRecordList[idx]) === null || _a === void 0 ? void 0 : _a[yField] : record[yField];
      if ((rangeY === null || rangeY === void 0 ? void 0 : rangeY[0]) <= yValue && (rangeY === null || rangeY === void 0 ? void 0 : rangeY[1]) >= yValue) {
        return true;
      }
      return false;
    });
