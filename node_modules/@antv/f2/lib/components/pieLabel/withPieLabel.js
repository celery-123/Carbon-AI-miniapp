...
var _default = exports.default = function _default(View) {
  return /** @class */function (_super) {
    ...
    function PieLabel(props) {
      ...
      _this.getSpiderLabels = function (props) {
        var _a, _b, _c, _d;
        var chart = props.chart,
          ...
          customRecords = props.records;
        var adjust = chart.adjust;
        var _e = _this.context,
          measureText = _e.measureText,
          px2hd = _e.px2hd;
        ...
        var allRecords = geometry.flatRecords();
        var records = allRecords;
        if (customRecords) {
          var _f = adjust.adjust,
            xField_1 = _f.xField,
            yField_1 = _f.yField;
          var colorField_1 = (_b = (_a = geometry.attrs) === null || _a === void 0 ? void 0 : _a.color) === null || _b === void 0 ? void 0 : _b.field;
          records = customRecords.map(function (record) {
            return allRecords.find(function (d) {
              return d.origin[colorField_1] === record[colorField_1] && d.origin[xField_1] === record[xField_1] && d.origin[yField_1] === record[yField_1];
            });
          }).filter(Boolean);
        }
        // 高度计算，拿第一项数据作为计算依据
        var label1Text = (0, _util.isFunction)(label1) ? label1((_c = records[0]) === null || _c === void 0 ? void 0 : _c.origin, records[0]) : label1;
        var label2Text = (0, _util.isFunction)(label2) ? label2((_d = records[0]) === null || _d === void 0 ? void 0 : _d.origin, records[0]) : label2;
        var height = measureText(label1Text.text, (0, _tslib.__assign)({
          fontSize: '24px',
          lineHeight: '24px'
        }, label1Text)).height + measureText(label2Text.text, (0, _tslib.__assign)({
          fontSize: '24px',
          lineHeight: '24px'
        }, label2Text)).height + px2hd(label1OffsetY) + px2hd(label2OffsetY) + 2;
        var maxCountForOneSide = Math.floor(coordHeight / (itemHeight || height));
        var maxCount = maxCountForOneSide * 2;
        // 按角度大到小排序
        var showrecords = records.sort(function (a, b) {
        ...
        showrecords.forEach(function (record) {
        ...
        if (halves[0].length > maxCountForOneSide) {
          ...
          var _g = move(halves[1], halves[0], halves[1].length - maxCountForOneSide, center),
            right = _g[0],
            left = _g[1];
          halves = [left, right];
        }
        ...
        halves.forEach(function (half, index) {
          ...
          labels = labels.concat((0, _spider.adjustPosition)(half, showSide, props, labelWidth));
        });
        return labels;
      };
      return _this;
    ...
    PieLabel.prototype.getLabels = function (props) {
      ...
      var chart = props.chart,
        ...
        label2 = props.label2,
        _a = props.height,
        itemHeight = _a === void 0 ? context.px2hd('64px') : _a,
        sidePadding = props.sidePadding;
      var center = coord.center,
        radius = coord.radius,
        coordWidth = coord.width,
      ...
      if (halves[0].length > maxCountForOneSide) {
        ...
        var _b = move(halves[1], halves[0], halves[1].length - maxCountForOneSide, center),
          right = _b[0],
          left = _b[1];
        halves = [left, right];
      }
