...
var withTreemap = function withTreemap(View) {
  return /** @class */function (_super) {
    ...
    Treemap.prototype.generateSelectionStyle = function (record, isSelected) {
      var _a;
      if (!((_a = this.state.selected) === null || _a === void 0 ? void 0 : _a.length)) {
        return null;
      }
      var _b = this.props.selection || {},
        selectedStyle = _b.selectedStyle,
        unSelectedStyle = _b.unSelectedStyle;
      var style = isSelected ? selectedStyle : unSelectedStyle;
      return (0, _util.isFunction)(style) ? style(record) : style;
    };
    ...
    Treemap.prototype.treemapLayout = function () {
      ...
      return nodes.children.map(function (item) {
        ...
        var selected = _this.isSelected(data);
        var style = _this.generateSelectionStyle(data, selected);
