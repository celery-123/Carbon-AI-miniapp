...
var Canvas = /** @class */function () {
  function Canvas(props) {
    var context = props.context,
      ...
      offscreenCanvas = props.offscreenCanvas,
      isTouchEvent = props.isTouchEvent,
      isMouseEvent = props.isMouseEvent,
      _c = props.useNativeClickEvent,
      useNativeClickEvent = _c === void 0 ? true : _c;
    ...
    var _d = canvas.getConfig(),
      canvasWidth = _d.width,
      canvasHeight = _d.height;
    // 设置默认的全局样式
  ...
  Canvas.prototype.render = function () {
    return __awaiter(this, void 0, void 0, function () {
      var _a, canvas, vNode, props, onRender;
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _a = this, canvas = _a.canvas, vNode = _a.vNode, props = _a.props;
            onRender = props.onRender;
            return [4 /*yield*/, canvas.ready];
          case 1:
            _b.sent();
            onRender && canvas.addEventListener('rerender', function () {
              return onRender(canvas);
            }, {
              once: true
            });
            render(vNode);
