...
import { computeLayout, createNodeTree, computeCSSLayout, fillElementLayout, fillComponentLayout, computeComponentBBox } from './computeLayout';
...
function getUpdateAnimation(component, newChildren, keyFrame) {
  ...
  // 创建动画
  var childrenAnimation = createAnimation(preNode, nextChildren, lastChildren);
  component.didUpdate();
  // 处理 animator
  var animUnits = calAnimationTime(childrenAnimation, keyFrame);
  return animUnits;
}
