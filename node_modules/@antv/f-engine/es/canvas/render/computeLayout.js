...
function hasFlexDisplay(node) {
  ...
  var style = node.style,
    children = node.children,
    vNode = node.vNode;
  if ((vNode === null || vNode === void 0 ? void 0 : vNode.tag) === Shape && (style === null || style === void 0 ? void 0 : style.display) === 'flex') {
    return true;
  }
...
function traverseNodeTreeAndCreateShapes(node, parentShape, context) {
  ...
  var _a = vNode.style,
    ...
    _b = vNode.attrs,
    attrs = _b === void 0 ? {} : _b;
  var style = context.px2hd(__assign(__assign(__assign({}, originStyle), customStyle), attrs));
